 ...
 * Essa classe foi gerada por uma biblioteca(BuilderMaster)
 *
 */
public class LocacaoBuilder {
	...
	public static void inicializarDadosPadroes(LocacaoBuilder builder) {
		...
		//Pode ser utilizado builders dentro de outra builder, segue o exemplo:
		elemento.setUsuario(UsuarioBuilder.umUsuario().agora());
		elemento.setFilmes(Arrays.asList(FilmeBuilder.umFilme().agora(),FilmeBuilder.umFilme().agora()));
